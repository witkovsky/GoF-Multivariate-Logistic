function Rinf = Rstat_ExpectedValue_Expansion(d, a, method, upperLimit)
% RSTAT_EXPECTEDVALUE_EXPANSION Computes the expected value E[R_{inf,a}]
%   based on Theorem 8 in Popović, Mijanović, and Witkovský (2025). The
%   computation combines the integrals J, I_A, I_B, and I_C according to
%   their definitions in Lemma 3, and Lemmas 7-9.
%
% SYNTAX:
%   Rinf = Rstat_ExpectedValue_Expansion(d, a)
%   Rinf = Rstat_ExpectedValue_Expansion(d, a, method, upperLimit)
%
% INPUT:
...
%
% EXAMPLES:
%   Rinf = Rstat_ExpectedValue_Expansion(3, 2)
%   Rinf = Rstat_ExpectedValue_Expansion(3, 2, 'zeta')
%   Rinf = Rstat_ExpectedValue_Expansion(3, 2, 'integral')
%   Rinf = Rstat_ExpectedValue_Expansion(3, 2, 'integral', 20)
