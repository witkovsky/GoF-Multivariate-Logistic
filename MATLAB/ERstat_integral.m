function R = ERstat_integral(d, a, upperLimit)
% ERSTAT_INTEGRAL Computes the expected value E[R_{inf,a}] by numerical
% integration. This function is based on the integral representation
% derived from the asymptotic behavior of the multivariate logistic
% characteristic function. 
%
% SYNTAX:
%   R = ERstat_integral(d, a, upperLimit)
%
% INPUT:
...
%
% EXAMPLES:
%   Rinf = ERstat_integral(2, 2)
%   Rinf = ERstat_integral(2, 2, 20)
%   Rinf = ERstat_integral(3, 2)
