function R = Rstat_Expected_integral(d, a, upperLimit)
% RSTAT_EXPECTED_INTEGRAL Computes the expected value E[R_{inf,a}] by
...
%
% SYNTAX:
%   R = Rstat_Expected_integral(d, a, upperLimit)
%
% INPUT:
...
%
% EXAMPLES:
%   Rinf = Rstat_Expected_integral(2, 2)
%   Rinf = Rstat_Expected_integral(2, 2, 20)
%   Rinf = Rstat_Expected_integral(3, 2)
