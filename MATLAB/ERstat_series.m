function Rinf = ERstat_series(d, a, method, upperLimit)
% EXSTAT_SERIES Computes the expected value E[R_{inf,a}] based on Theorem 8
% in Popović, Mijanović and Witkovský (2025). The computation combines the
% integrals J, I_A, I_B, and I_C according to their definitions in Lemma 3, 
% and Lemmas 7-9. 
%
% SYNTAX:
%   Rinf = ERstat_series(d, a)
%   Rinf = ERstat_series(d, a, method, upperLimit)
%
% INPUT:
...
%
% EXAMPLES:
%   Rinf = ERstat_series(3, 2)
%   Rinf = ERstat_series(3, 2, 'zeta')
%   Rinf = ERstat_series(3, 2, 'integral')
%   Rinf = ERstat_series(3, 2, 'integral', 20)
